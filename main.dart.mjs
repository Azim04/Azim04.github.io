...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1218: x0 => x0.length,
      _1323: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1334: Date.now,
      ...
      _1338: () => new Error().stack,
      _1339: () => typeof dartUseDateNowForTicks !== "undefined",
      _1340: () => 1000 * performance.now(),
      _1341: () => Date.now(),
      _1342: () => {
      ...
      _1344: () => new WeakMap(),
      _1345: (map, o) => map.get(o),
      _1346: (map, o, v) => map.set(o, v),
      _1347: (exn) => exn.toString(),
      _1348: (exn) => exn.stack,
      _1349: (exn) => {
      ...
      _1375: Object.is,
      _1379: (o, c) => o instanceof c,
      _1380: o => Object.keys(o),
      _1410: x0 => new Array(x0),
      _1412: x0 => x0.length,
      _1414: (x0,x1) => x0[x1],
      _1415: (x0,x1,x2) => { x0[x1] = x2 },
      _1418: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1420: x0 => new Int8Array(x0),
      _1421: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1423: x0 => new Uint8ClampedArray(x0),
      _1425: x0 => new Int16Array(x0),
      _1427: x0 => new Uint16Array(x0),
      _1429: x0 => new Int32Array(x0),
      _1431: x0 => new Uint32Array(x0),
      _1433: x0 => new Float32Array(x0),
      _1435: x0 => new Float64Array(x0),
      _1459: x0 => x0.random(),
      _1462: () => globalThis.Math,
      _1475: (ms, c) =>
      ...
      _1514: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1514(f,arguments.length,x0,x1) }),
      _1515: o => {
      ...
      _1541: (o, p) => p in o,
      _1542: (o, p) => o[p],
      _1569: () => new AbortController(),
      _1570: x0 => x0.abort(),
      _1571: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1572: (x0,x1) => globalThis.fetch(x0,x1),
      _1573: (x0,x1) => x0.get(x1),
      _1574: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1574(f,arguments.length,x0,x1,x2) }),
      _1575: (x0,x1) => x0.forEach(x1),
      _1576: x0 => x0.getReader(),
      _1577: x0 => x0.cancel(),
      _1578: x0 => x0.read(),
      _1579: o => o instanceof Array,
      _1580: (a, i) => a.push(i),
      _1584: a => a.pop(),
      _1585: (a, i) => a.splice(i, 1),
      _1586: (a, s) => a.join(s),
      _1587: (a, s, e) => a.slice(s, e),
      _1589: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1590: a => a.length,
      _1592: (a, i) => a[i],
      _1593: (a, i, v) => a[i] = v,
      _1595: o => {
      ...
      _1596: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1598: o => o instanceof Uint8Array,
      _1599: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1600: o => o instanceof Int8Array,
      _1601: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1602: o => o instanceof Uint8ClampedArray,
      _1603: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1604: o => o instanceof Uint16Array,
      _1605: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1606: o => o instanceof Int16Array,
      _1607: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1608: o => o instanceof Uint32Array,
      _1609: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1610: o => o instanceof Int32Array,
      _1611: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1613: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1614: o => o instanceof Float32Array,
      _1615: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1616: o => o instanceof Float64Array,
      _1617: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1618: (t, s) => t.set(s),
      _1620: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1622: o => o.buffer,
      _1623: o => o.byteOffset,
      _1624: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1625: (b, o) => new DataView(b, o),
      _1626: (b, o, l) => new DataView(b, o, l),
      _1627: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1628: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1629: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1630: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1631: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1632: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1633: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1634: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1635: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1636: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1637: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1638: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1641: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1642: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1643: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1644: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1645: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1646: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1647: Function.prototype.call.bind(Number.prototype.toString),
      _1648: Function.prototype.call.bind(BigInt.prototype.toString),
      _1649: Function.prototype.call.bind(Number.prototype.toString),
      _1650: (d, digits) => d.toFixed(digits),
